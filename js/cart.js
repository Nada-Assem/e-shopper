...
`;
            ...
            cart_Amount_content.style.alignItems = 'center';
            cart_Amount_content.classList.add("row");
            ...
            cart_Amount_number.classList.add("col-2");
            ...
            cart_Amount_plus.classList.add("col-2");
            ...
            cart_Amount_plus.appendChild(plus);


            const love_Icon = document.createElement("div");
            love_Icon.classList.add("love_Icon");
            love_Icon.classList.add("col-2");
            love_Icon.classList.add("offset-2");
            cart_Amount_content.appendChild(love_Icon);
            ...
            card_trash2.classList.add("col-2");
            ...
            cart_Amount_content.appendChild(card_trash2);
            ...
            card_trash2.addEventListener('click',()=>{
